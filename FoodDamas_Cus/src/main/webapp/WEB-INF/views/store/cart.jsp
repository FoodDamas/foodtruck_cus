...
<body>
	...
	<div class="cart-wrap">
		...
		<div class="cart">
			<div class="restaurant-name">놀부부대찌개-반포점</div>
			<ul class="list-group">
...
<a class="btn " style="float: right; font-size: 16px; font-weight: bold">X</a> 
					...
					<div class="row" >
						...
						<div class="menu-name">놀부부대찌개（2인）: 놀부부대찌개</div>
						<div>
							<div class="col-xs-5 pull-left">
								<span class="order-price">15,000원</span>
							</div>
			...
			<div class="cart-btn clearfix">
				<a class="btn btn-lg btn-ygy2 btn-left">메뉴추가</span>
				</a> <a class="btn btn-lg btn-ygy1 btn-right">주문하기</a>
			</div>
		</div>
	</div>
